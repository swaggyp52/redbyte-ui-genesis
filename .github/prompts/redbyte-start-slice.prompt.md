...
- If this slice starts from natural-language product feedback, run `pnpm rb:problem:intake -- "<raw feedback>"` before implementation. Do not skip the problem packet for ambiguous product complaints.
...
docs/product/RED_BYTE_PRODUCT_FEEDBACK_LOOP.md
docs/product/RED_BYTE_PRODUCT_PROBLEM_INTAKE.md
...
1. If a product problem packet exists, preserve its raw feedback, do-not-build list, overengineering risks, and definition of done.
