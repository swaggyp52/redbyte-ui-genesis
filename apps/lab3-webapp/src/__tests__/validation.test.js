...
import { validateTruthTable, validateExpressions, validateLabDoc, getValidationMessage, } from '../validation';
...
describe('Validation Module', () => {
    ...
    describe('getValidationMessage()', () => {
        ...
        it('should return error message with error count', () => {
            const errors = [
                { severity: 'error', segment: 'a', input: 0, message: 'Error 1' },
                { severity: 'warning', segment: 'b', input: 0, message: 'Warning 1' },
            ];
            const summary = {
                totalErrors: 2,
                isValid: false,
