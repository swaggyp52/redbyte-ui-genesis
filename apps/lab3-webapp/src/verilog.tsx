    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-slate-50 rounded-lg p-6">
        ...
        <p className="text-slate-300 text-sm mb-4">
          Paste a case statement from your Vivado implementation to import and verify against your truth table.
        </p>
        <textarea
          value={pastedVerilog}
          onChange={(e) => setPastedVerilog(e.target.value)}
          placeholder="Paste your case, endcase block here..."
        ...
        <button
          ...
          className="mt-3 px-6 py-2 bg-purple-700 hover:bg-purple-600 rounded font-medium transition-colors"
        >
          Parse & Update Table
        </button>
      </div>
