...
import type { PresetSuite } from './vectorRunner';
...
export interface LabDefinition {
    ...
    constraints?: {
        ...
        requiredIoMapping?: {
            inputs: { pattern: string; role: string }[];
            outputs: { pattern: string; role: string }[];
        };
    };
    metadata: {
        hardwareRequired: boolean;
        board: 'basys3' | 'spartan3e';
...
export interface LabStepDef {
    ...
    title: string;
    description: string;
    markdown?: string; // Optional detailed content
    media?: {
...
export const LAB2_ADDER_PRESETS: PresetSuite = {
...
export const LAB_2_ADDER_CONTENT: LabDefinition = {
    id: 'lab2_adder',
