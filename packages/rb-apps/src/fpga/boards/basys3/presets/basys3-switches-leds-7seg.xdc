## RedByte Basys 3 XDC Preset — Switches + LEDs + Buttons + 7-Segment
## Board: Basys 3 (xc7a35tcpg236-1)
## Teaching-first ports:
##   - clk
##   - sw[15:0]
##   - led[15:0]
##   - btn[4:0] (btn[0]=C, btn[1]=U, btn[2]=L, btn[3]=R, btn[4]=D)
##   - seg[6:0], dp, an[3:0]   (active low)
