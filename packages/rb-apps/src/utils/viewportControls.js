...
const FIT_MARGIN = 40;
export function useViewportControls(options) {
    ...
    const zoom = useCallback((deltaZoom, centerX, centerY) => {
        setState((prev) => {
 ...
 */
export function useViewportKeyboard(viewport, getContentBounds) {
    useEffect(() => {
 ...
 */
export function useViewportWheel(containerRef, viewport, zoomSpeed = 0.001) {
    useEffect(() => {
 ...
 */
export function useViewportPan(containerRef, viewport) {
