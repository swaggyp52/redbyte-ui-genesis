 ...
 */
export function reportPerfViolation(label, durationMs, budgetMs, opts = {}) {
    // Sample to avoid flooding
    if (Math.random() > perfSampleRate)
        return;
