...
const ViewRenderer = ({ view, engine, tickEngine, circuit, isRunning, windowId, tickCount, debugSignals, debugTick, mismatchWireHighlights, mismatchNodeIds, mismatchPortKeys, canUndo, canRedo, onUndo, onRedo, onCircuitChange, onNodeDoubleClick, viewStateStore, width, height, showCircuitHints, onDismissCircuitHints, showSchematicHints, onDismissSchematicHints, show3DHints, onDismiss3DHints, showOscilloscopeHints, onDismissOscilloscopeHints, getChipMetadata, onInputToggled, onProbeToggle, probedPorts, probeWireHighlights, highlightedPort, isReplayMode, onHelpOpen, disableToolStrip = false, onSignalsUpdated, latestSignals, signalsUpdateReason, signalsVersion, onNetHighlightWiresChanged, netHighlightWireIds, }) => {
            ...
            case '3d':
                {
                    ...
                    if (disable3d || performanceMode) {
                        return (_jsx("div", { ref: containerRef, style: containerStyle, className: "flex items-center justify-center text-sm text-gray-300", children: performanceMode ? '3D view disabled in Performance Mode.' : '3D view disabled by flag.' }));
                    }
                    return (_jsx("div", { ref: containerRef, style: containerStyle, children: _jsx(ErrorBoundary, { fallbackTitle: "3D View crashed", children: _jsx(React.Suspense, { fallback: _jsx("div", { className: "flex items-center justify-center h-full text-[var(--rb-text-3)] text-sm", children: "Loading 3D\u2026" }), children: _jsx(Logic3DSceneLazy, { engine: engine, width: dimensions.width, height: dimensions.height, viewStateStore: viewStateStore, getChipMetadata: getChipMetadata, showHints: show3DHints, onDismissHints: onDismiss3DHints, probeWireHighlights: probeWireHighlights, netHighlightWireIds: netHighlightWireIds, mismatchWireHighlights: mismatchWireHighlights, mismatchNodeIds: mismatchNodeIds, mismatchPortKeys: mismatchPortKeys, debugSignals: signalsUpdateReason === 'input' ? latestSignals : debugSignals, onHelp: onHelpOpen ? () => onHelpOpen('3d-controls') : undefined, onLayoutChange: () => {
...
export const SplitViewLayout = ({ mode, views, splitRatio = 0.5, windowId, engine, tickEngine, circuit, isRunning, tickCount, debugSignals, debugTick, mismatchWireHighlights, mismatchNodeIds, mismatchPortKeys, canUndo, canRedo, onUndo, onRedo, onCircuitChange, onNodeDoubleClick, viewStateStore, showCircuitHints, onDismissCircuitHints, showSchematicHints, onDismissSchematicHints, show3DHints, onDismiss3DHints, showOscilloscopeHints, onDismissOscilloscopeHints, getChipMetadata, onInputToggled, onProbeToggle, probedPorts, probeWireHighlights, highlightedPort, isReplayMode, onHelpOpen, }) => {
