...
export const SWITCH_POSITIONS: Record<number, ElementPosition> = {};
export const LED_POSITIONS: Record<number, ElementPosition> = {};
...
export const BUTTON_POSITIONS: Record<string, ElementPosition> = {
