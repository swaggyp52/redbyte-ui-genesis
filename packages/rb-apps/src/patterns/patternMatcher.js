 ...
 */
function calculateGateTypeScore(circuitGates, patternGates) {
    let score = 0;
    ...
    const extraGateTypes = Object.keys(circuitGates).filter((type) => !patternGates[type]);
