...
export async function ingestLabSubmission(bytes, opts) {
...
export async function fetchLabRuns(opts) {
...
export async function fetchLabRunDetail(runId, opts) {
...
export async function diffLabRun(runId, goldenFixture, opts) {
