...
export const useSettingsStore = Object.assign((selector) => selector ? selector(mockSettingsState) : mockSettingsState, {
    getState: () => mockSettingsState,
    setState: vi.fn(),
    subscribe: vi.fn(() => vi.fn()),
});
export const useUiTickStore = Object.assign((selector) => selector ? selector(mockUiTickState) : mockUiTickState, {
