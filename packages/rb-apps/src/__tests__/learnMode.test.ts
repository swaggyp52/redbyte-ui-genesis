...
describe('Learn Mode', () => {
  ...
  describe('isExampleComplete', () => {
    ...
    it('should return false when some steps completed', () => {
      const example = GUIDED_EXAMPLES['not-gate'];
      const completedSteps = new Set<string>(['add-switch', 'add-not']);
  ...
  describe('validateCurrentStep - NOT Gate', () => {
    it('should validate first step - add switch', () => {
      ...
      const circuitWithoutSwitch: Circuit = {
        nodes: [],
        connections: [],
      };
      ...
      expect(validateCurrentStep(example, completedSteps, circuitWithoutSwitch).isValid).toBe(
        false
      );
    ...
    it('should validate wiring step - switch to NOT', () => {
      const example = GUIDED_EXAMPLES['not-gate'];
      const completedSteps = new Set<string>(['add-switch', 'add-not', 'add-lamp']);
  ...
  describe('validateCurrentStep - Half Adder', () => {
    it('should validate first step - add two switches', () => {
      ...
      expect(validateCurrentStep(example, completedSteps, circuitWithOneSwitch).isValid).toBe(
        false
      );
      expect(validateCurrentStep(example, completedSteps, circuitWithTwoSwitches).isValid).toBe(
        true
      );
    });
