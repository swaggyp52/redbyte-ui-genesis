...
vi.mock('@redbyte/rb-utils', async (importOriginal) => {
    ...
    return {
        ...actual,
        useSettingsStore: Object.assign((selector) => selector ? selector(mockSettingsState) : mockSettingsState, {
...
vi.mock('@redbyte/rb-shell', () => ({
    useToastStore: Object.assign(() => ({ addToast: vi.fn() }), {
...
vi.mock('@redbyte/rb-windowing', () => {
    ...
    return {
        useWindowStore: Object.assign((selector) => selector ? selector(mockWindowState) : mockWindowState, {
...
vi.mock('../tutorial/tutorialStore', () => {
    ...
    return {
        useTutorialStore: Object.assign((selector) => selector ? selector(mockTutorialState) : mockTutorialState, {
...
vi.mock('../stores/layoutStore', () => {
    ...
    return {
        useLayoutStore: Object.assign((selector, _equalityFn) => selector ? selector(mockLayoutState) : mockLayoutState, {
...
vi.mock('../stores/hierarchyStore', () => {
    ...
    return {
        useHierarchyStore: Object.assign((selector, _equalityFn) => selector ? selector(mockHierarchyState) : mockHierarchyState, {
...
vi.mock('../stores/runRecorderStore', () => {
    ...
    return {
        useRunRecorderStore: Object.assign((selector, _equalityFn) => selector ? selector(mockRunRecorderState) : mockRunRecorderState, {
...
describe.skip('Playground - Palette Interaction (PR0 Baseline)', () => {
    ...
    it('should have engines connected when circuit mutations occur', async () => {
        ...
        expect(consoleSpy).not.toHaveBeenCalledWith(expect.stringContaining('[CircuitStore] Circuit mutation called but engines not connected'));
    ...
    it('should delete selected nodes when selection exists', async () => {
        ...
        await act(async () => {
            ...
            const updatedCircuit = {
                ...
                connections: currentCircuit.connections.filter((c) => !selection.nodes.has(c.from.nodeId) && !selection.nodes.has(c.to.nodeId)),
            };
            // Update the circuit
