...
describe('PHASE_AG: Filesystem Data Settings Panel', () => {
    ...
    describe('Panel Rendering', () => {
        it('should render the panel with keyboard shortcuts information', () => {
            render(_jsx(FilesystemDataPanel, { onShowToast: mockShowToast }));
    ...
    describe('Export Functionality', () => {
        it('should open export modal on E key', () => {
            const { container } = render(_jsx(FilesystemDataPanel, { onShowToast: mockShowToast }));
            ...
            const exportTextarea = textareas.find((ta) => ta.readOnly);
        ...
        it('should display deterministic JSON in export modal', () => {
            ...
            const textarea = screen.getByDisplayValue(/test-export.txt/i);
    ...
    describe('Import Functionality', () => {
        ...
        it('should apply valid JSON on Enter', async () => {
            ...
            const textarea = screen.getByPlaceholderText(/version/i);
    ...
    describe('Regression: Integration with Filesystem', () => {
        it('should export and import roundtrip preserving state', async () => {
            ...
            panelDiv.focus();
            fireEvent.keyDown(panelDiv, { key: 'E' });
            const exportTextarea = screen.getByDisplayValue(/roundtrip-test.txt/i);
            ...
            panelDiv.focus();
            fireEvent.keyDown(panelDiv, { key: 'I' });
            const importTextarea = screen.getByPlaceholderText(/version/i);
    ...
    describe('PHASE_AH: Factory Reset', () => {
        ...
        it('should disable confirm button until RESET typed', () => {
            ...
            panelDiv.focus();
            fireEvent.keyDown(panelDiv, { key: 'F' });
            const factoryResetButton = screen.getByText('Factory Reset', { selector: 'button' });
