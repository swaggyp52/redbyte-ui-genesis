 ...
 */
function createModerateCircuit() {
...
describe('Phase 4: Probe Sampling Gate', () => {
    ...
    it('handles multiple probes without exceptions', () => {
        ...
        for (let i = 0; i < ticks; i++) {
            ...
            recorders.q0.record(i, q0);
            recorders.q1.record(i, q1);
            recorders.q2.record(i, q2);
            recorders.q3.record(i, q3);
        }
