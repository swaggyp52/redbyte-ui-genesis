...
const ProbeHighlightCounter = ({ circuit }) => {
    ...
    return _jsx("div", { "data-testid": "highlight-count", children: highlights.size });
};
describe('probe toggle immediate feedback', () => {
    ...
    it('updates highlight output immediately on toggle', () => {
        ...
        render(_jsx(ProbeHighlightCounter, { circuit: circuit }));
        let probeId = '';
        act(() => {
