...
describe('Chip System', () => {
    ...
    describe('Chip Store', () => {
        it('should save a chip from pattern', () => {
            ...
            const inputs = [
                { id: 'input-0', name: 'A', type: 'input', nodeRef: 'input-a.out' },
                { id: 'input-1', name: 'B', type: 'input', nodeRef: 'input-b.out' },
            ];
            const outputs = [
                { id: 'output-0', name: 'OUT', type: 'output', nodeRef: 'output.in' },
            ];
    ...
    describe('Chip Port Utilities', () => {
        ...
        it('should validate chip ports reference valid nodes', () => {
            ...
            const invalidInputs = [
                { id: 'input-0', name: 'A', type: 'input', nodeRef: 'nonexistent.out' },
            ];
        ...
        it('should detect duplicate port names', () => {
            ...
            const duplicateInputs = [
                { id: 'input-0', name: 'A', type: 'input', nodeRef: 'input-a.out' },
                { id: 'input-1', name: 'A', type: 'input', nodeRef: 'input-a.out' },
            ];
            const validOutputs = [
                { id: 'output-0', name: 'OUT', type: 'output', nodeRef: 'output.in' },
            ];
