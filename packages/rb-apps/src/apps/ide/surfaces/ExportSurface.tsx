...
export const ExportSurface: React.FC<ExportSurfaceProps> = ({
  ...
  const evidenceDiagnostics = useMemo(
    () => buildEvidenceDiagnostics(verifyResult, dirtySinceVerify, vectorsAreAutoGenerated),
            ...
            {exportTrusted ? (
              ...
              <div className="ide-export-trust-row ide-export-trust-row--available">
                ...
                <div className="ide-export-readiness-strip" data-testid="ide-export-readiness-strip">
                  ...
                  >
                    {isStarterScenarioFail ? '⚠ Scenario: starter' : isNoRunYet ? '— Scenario: none' : '✓ Scenario: authored'}
                  </span>
                  <span
                    className={`ide-export-readiness-axis ${isStarterScenarioFail ? 'ide-export-readiness-axis--warn' : isNoRunYet ? 'ide-export-readiness-axis--idle' : 'ide-export-readiness-axis--fail'}`}
                    data-testid="ide-export-readiness-verify"
                  >
                    {isStarterScenarioFail ? '~ Verify: unsealed' : isNoRunYet ? '— Verify: never run' : '✗ Verify: failed'}
                  </span>
                </div>
