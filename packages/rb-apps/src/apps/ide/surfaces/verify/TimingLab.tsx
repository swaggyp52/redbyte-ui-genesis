    ...
    >
      <header className="rb-timing-bar" data-testid="ide-timing-lab-bar">
        ...
        {generatedFieldIds && generatedFieldIds.size > 0 ? (
          <span className="rb-timing-generated" data-testid="ide-timing-generated" title={generatedNote}>
            {generatedNote ?? 'Clock and reset are generated by the clock policy'}
          </span>
        ) : null}
