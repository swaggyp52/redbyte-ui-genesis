...
const SettingsComponent = ({ onClose }) => {
    ...
    const { themeVariant, wallpaperId, setThemeVariant, setWallpaperId, tickRate, setTickRate, reduceMotion, setReduceMotion, density, setDensity, snapAssist, setSnapAssist, } = useSettingsStore();
    useEffect(() => {
