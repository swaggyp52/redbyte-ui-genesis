...
export const InstructorAppContent = ({ onNavigate }) => {
    ...
    if (selectedRunId) {
        return (_jsx(InstructorRunDetailAppContent, { runId: selectedRunId, onNavigate: (_appId, _props) => {
