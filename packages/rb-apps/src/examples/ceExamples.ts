...
import type { CEExample } from '../components/CEUIComponents';
...
export const WEEK0_HELLO_GATES: CEExample = {
  id: 'w0-hello-gates',
  title: 'Hello Gates',
  description:
    'Your first circuit! Power source → AND gate → Lamp. Flip the switch to turn the lamp on.',
  week: 0,
...
export const WEEK0_XOR_DEMO: CEExample = {
  id: 'w0-xor-demo',
  title: 'XOR Demo',
  description:
    'See the difference between AND (both ON) and XOR (exactly one ON). Non-linearity in action!',
  week: 0,
  category: 'orientation',
  circuit: {
    nodes: [
...
export const WEEK1_HALF_ADDER: CEExample = {
  id: 'w1-half-adder',
  title: 'Half Adder',
  description:
    'Adds two 1-bit numbers. XOR for sum, AND for carry. Try all four input combinations.',
  week: 1,
...
export const WEEK1_FULL_ADDER: CEExample = {
  id: 'w1-full-adder',
  title: 'Full Adder',
  description:
    'Adds three 1-bit numbers (A, B, Cin). Uses two half adders + OR. Try all 8 input combinations.',
  week: 1,
  category: 'combinational',
  circuit: {
    nodes: [
...
export const WEEK2_2TO1_MUX: CEExample = {
  id: 'w2-2to1-mux',
  title: '2:1 Multiplexer',
  description:
    'Selects between two inputs (A, B) using a select line (S). When S=0, output=A; when S=1, output=B.',
  week: 2,
  category: 'selection',
  circuit: {
    nodes: [
...
export const WEEK2_4TO1_MUX: CEExample = {
  id: 'w2-4to1-mux',
  title: '4:1 Multiplexer',
  description:
    'Selects one of 4 inputs using 2 select lines. Builds on 2:1 MUX concept with cascading logic.',
  week: 2,
  category: 'selection',
  circuit: {
    nodes: [
...
export const CE_EXAMPLE_PACK: CEExample[] = [
  // Week 0
  WEEK0_HELLO_GATES,
  WEEK0_XOR_DEMO,
  // Week 1
 ...
 */
export function getExamplesByWeek(week: 0 | 1 | 2): CEExample[] {
 ...
 * Get example by ID
 */
export function getExampleById(id: string): CEExample | undefined {
