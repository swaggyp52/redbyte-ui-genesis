...
import { parseCapsule, loadEventsNdjson, verifyHashes, normalizeEvent, diffCapsules, computeVectorVerdicts, buildTimelineRows, summarizeCapsule, } from '../src/index';
const mockCapsule = {
...
describe('rb-fpga-proof-core', () => {
    describe('parseCapsule', () => {
        ...
        it('should support test_summary (dual schema)', () => {
            ...
            delete capsule.summary;
            capsule.test_summary = { total: 3, pass: 2, fail: 1 };
    ...
    describe('verifyHashes', () => {
        ...
        it('should fail missing session_id', () => {
            const bad = { ...mockCapsule, session_id: '' };
