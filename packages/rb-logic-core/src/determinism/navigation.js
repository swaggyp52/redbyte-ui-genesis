 ...
 */
export function stepForward(initialCircuit, eventLog, currentSnapshot, options) {
 ...
 */
export function stepBackward(initialCircuit, eventLog, currentSnapshot, options) {
 ...
 */
export function jumpToIndex(initialCircuit, eventLog, targetIndex, options) {
 ...
 */
export function canStepForward(currentSnapshot) {
 ...
 */
export function canStepBackward(currentSnapshot) {
