...
describe('Time Travel Integration (PR10: Milestone C)', () => {
    ...
    it('E2E Test 1: Complete time travel workflow with recording, inspection, navigation, and diffing', () => {
        ...
        const andGateSignalChange = diff2to4.signalChanges.find((c) => c.nodeId === 'andGate' && c.portName === 'out');
        ...
        const andGateSignalChange2 = diff4to6.signalChanges.find((c) => c.nodeId === 'andGate' && c.portName === 'out');
