...
describe('RBProjectDoc', () => {
  ...
  describe('normalizeProjectDoc', () => {
    it('fills in defaults for partial doc', () => {
      const partial: Partial<RBProjectDoc> = {
    ...
    it('preserves existing fields', () => {
      ...
      doc.circuit.nodes = [{ id: 'n1', type: 'PowerSource', x: 0, y: 0 }] as any;
  ...
  describe('updateProjectDocTimestamp', () => {
    ...
    it('preserves all other fields', () => {
      const doc = createBlankProjectDoc();
      doc.meta.name = 'Test';
      doc.circuit.nodes = [{ id: 'n1', type: 'AND', x: 0, y: 0 }] as any;
  ...
  describe('Round-trip serialization', () => {
    it('survives serialize -> deserialize -> serialize cycle', () => {
      ...
      original.circuit.nodes = [{ id: 'n1', type: 'AND', x: 10, y: 20 }] as any;
