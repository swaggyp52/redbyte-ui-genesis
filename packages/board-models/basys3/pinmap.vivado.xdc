## Basys 3 Rev B Master Constraints File for RedByte
## Part: xc7a35tcpg236-1
## Adapted from Digilent Basys 3 reference
...
## Pmod Header JXADC (directly connected to FPGA ADC inputs)
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports {xa_p[0]}]
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports {xa_n[0]}]
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {xa_p[1]}]
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {xa_n[1]}]
set_property -dict { PACKAGE_PIN K3   IOSTANDARD LVCMOS33 } [get_ports {xa_p[2]}]
set_property -dict { PACKAGE_PIN M3   IOSTANDARD LVCMOS33 } [get_ports {xa_n[2]}]
set_property -dict { PACKAGE_PIN M1   IOSTANDARD LVCMOS33 } [get_ports {xa_p[3]}]
set_property -dict { PACKAGE_PIN N1   IOSTANDARD LVCMOS33 } [get_ports {xa_n[3]}]

## USB-RS232 Interface (directly usable for debugging)
set_property -dict { PACKAGE_PIN B18  IOSTANDARD LVCMOS33 } [get_ports RsRx]
set_property -dict { PACKAGE_PIN A18  IOSTANDARD LVCMOS33 } [get_ports RsTx]

## USB HID (directly usable for USB keyboard/mouse)
#set_property -dict { PACKAGE_PIN C17  IOSTANDARD LVCMOS33 PULLUP TRUE } [get_ports PS2Clk]
#set_property -dict { PACKAGE_PIN B17  IOSTANDARD LVCMOS33 PULLUP TRUE } [get_ports PS2Data]

## Quad SPI Flash (directly usable for configuration storage)
