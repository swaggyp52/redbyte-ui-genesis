...
export const Logic3DScene = ({ engine, width = 800, height = 600, viewStateStore, showHints = true, onDismissHints, onHelp, probeWireHighlights, netHighlightWireIds, mismatchWireHighlights, mismatchNodeIds, debugSignals, forcedTime, onLayoutChange, }) => {
