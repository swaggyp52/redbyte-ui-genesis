...
import { convertCircuitV1ToCircuit, convertCircuitToCircuitV1, prepareImportedProjectState, getVirtualLabSimulationState, validateVirtualLabState, extractEvidenceData, validateEvidenceStructure, getUnifiedProjectStorePayload, validateUnifiedProjectStoreCompatibility, generateImportedProjectFilename, formatImportedProjectDisplayName, generateImportSummary, getImportWarnings, } from '../importWorkflowUtils.js';
// ============================================================================
// Test Helpers
// ============================================================================
...
describe('Import Workflow Utilities', () => {
    ...
    describe('Virtual Lab State Restoration', () => {
        ...
        it('should detect missing Virtual Lab state', () => {
            const project = createTestProject();
            delete project.simulation.tickRate;
            const validation = validateVirtualLabState(project);
    ...
    describe('Evidence & Checkpoint Data', () => {
        ...
        it('should detect invalid evidence structure', () => {
            const project = createTestProject();
            project.evidence.actions = null; // Invalid
            const validation = validateEvidenceStructure(project);
        ...
        it('should not warn about valid projects', () => {
            const project = createTestProject({
                ...
                circuit: {
                    schemaVersion: '1.0',
                    nodes: [
                        { id: 'n1', type: 'and', x: 0, y: 0, rotation: 0, label: 'AND', params: {}, state: {} },
                        { id: 'n2', type: 'or', x: 100, y: 0, rotation: 0, label: 'OR', params: {}, state: {} },
                    ],
                    connections: [
