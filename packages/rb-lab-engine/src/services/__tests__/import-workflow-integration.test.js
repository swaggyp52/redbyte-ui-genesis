 ...
 */
function getLogicPlaygroundCircuit(project) {
    return {
        ...
        it('should restore multi-node circuit with connections', async () => {
            const original = createTestProject({
                ...
                circuit: {
                    schemaVersion: '1.0',
                    nodes: [
                        { id: 'or-1', type: 'or', x: 50, y: 50, rotation: 0, label: 'OR1', params: {}, state: {} },
                        { id: 'and-1', type: 'and', x: 150, y: 50, rotation: 0, label: 'AND1', params: {}, state: {} },
                        { id: 'not-1', type: 'not', x: 250, y: 50, rotation: 0, label: 'NOT1', params: {}, state: {} },
                    ],
                    connections: [
                        {
                            id: 'conn-1',
        ...
        it('should provide circuit format compatible with Logic Playground', async () => {
            const original = createTestProject({
                ...
                circuit: {
                    schemaVersion: '1.0',
                    nodes: [
                        { id: 'n1', type: 'and', x: 10, y: 20, rotation: 0, label: 'A1', params: {}, state: {} },
                        { id: 'n2', type: 'or', x: 30, y: 40, rotation: 0, label: 'O1', params: {}, state: {} },
                    ],
                    connections: [
