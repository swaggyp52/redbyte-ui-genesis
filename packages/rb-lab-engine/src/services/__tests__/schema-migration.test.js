...
import { CURRENT_LAB_PROJECT_SCHEMA_VERSION, SUPPORTED_SCHEMA_VERSIONS, isSupportedVersion, migrateLabProject, validateLabProject, isFutureVersion, getSupportedVersionsInfo, } from '../schemaMigration.js';
/**
...
describe('Schema Versioning (Phase 3.5)', () => {
    ...
    describe('Schema Migration', () => {
        ...
        it('should reject unknown schema version', () => {
            const project = createTestProject({ schemaVersion: '99.0' });
            const result = migrateLabProject(project);
        ...
        it('should preserve unknown fields (forward compatibility)', () => {
            const projectWithExtra = createTestProject();
    ...
    describe('Migration Framework Readiness', () => {
        ...
        it('should maintain backward compatibility with future versions', () => {
            ...
            const futureProject = createTestProject({ schemaVersion: '2.0' });
