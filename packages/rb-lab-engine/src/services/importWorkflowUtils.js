 ...
 */
export function convertCircuitV1ToCircuit(circuitV1) {
    return {
 ...
 */
export function convertCircuitToCircuitV1(circuit, existing) {
    return {
 ...
 */
export function prepareImportedProjectState(project, source = 'user-file') {
 ...
 */
export function getVirtualLabSimulationState(project) {
    return {
 ...
 */
export function validateVirtualLabState(project) {
    return {
 ...
 */
export function extractEvidenceData(project) {
    return {
 ...
 */
export function validateEvidenceStructure(project) {
    if (!project.evidence) {
 ...
 */
export function getUnifiedProjectStorePayload(project) {
    return {
 ...
 */
export function validateUnifiedProjectStoreCompatibility(project) {
    const missingFields = [];
    ...
    if (!project.circuit)
        missingFields.push('circuit');
    if (!project.simulation)
        missingFields.push('simulation');
    if (!project.evidence)
 ...
 */
export function generateImportedProjectFilename(project) {
 ...
 */
export function formatImportedProjectDisplayName(project) {
    const maxLength = 50;
 ...
 */
export function generateImportSummary(project, success, warnings = []) {
    if (!success) {
 ...
 */
export function getImportWarnings(project) {
    const warnings = [];
    if (!project.name) {
