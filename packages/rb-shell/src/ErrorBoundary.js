		    ...
		    render() {
		        if (this.state.hasError) {
		            ...
		            const errorBox = this.state.error
		                ? _jsx("div", { className: "bg-slate-800 border border-slate-700 rounded p-3 mb-4", children: _jsx("p", { className: "text-xs font-mono text-red-400 break-all", children: studentError.message }) })
		                : null;

			            const factoryResetBox = _jsxs("div", {
			                className: "bg-slate-800 border border-yellow-700/30 rounded p-3",
			                children: [
			                    _jsx("p", {
			                        className: "text-xs text-yellow-400/90 mb-2",
			                        children: _jsx("strong", { children: "Factory Reset (clears all data):" }),
			                    }),
			                    _jsxs("ol", {
			                        className: "text-xs text-slate-400 space-y-1 list-decimal list-inside",
			                        children: [
			                            _jsx("li", { children: "Reload the page" }),
			                            _jsx("li", { children: "Open Settings (Ctrl+,)" }),
			                            _jsx("li", { children: "Go to Filesystem Data" }),
			                            _jsxs("li", {
			                                children: [
			                                    "Press ",
			                                    _jsx("kbd", {
			                                        className: "px-1 py-0.5 bg-slate-700 rounded text-red-400",
			                                        children: "F",
			                                    }),
			                                ],
			                            }),
			                            _jsxs("li", {
			                                children: [
			                                    "Type ",
			                                    _jsx("strong", { className: "text-white", children: "RESET" }),
			                                    " and confirm",
			                                ],
			                            }),
			                        ],
		            ...
		            const actions = _jsxs("div", { className: "space-y-3", children: [_jsx("button", { onClick: this.handleReload, className: "w-full px-4 py-2 text-sm rounded bg-cyan-600 hover:bg-cyan-500 text-white font-medium", children: "Reload Page" }), _jsx("button", { onClick: this.handleExportRecovery, className: "w-full px-4 py-2 text-sm rounded bg-slate-800 hover:bg-slate-700 text-slate-200 font-medium", children: "Export Recovery Bundle" }), _jsx("button", { onClick: this.handleCopyDiagnostics, className: "w-full px-4 py-2 text-sm rounded bg-slate-800 hover:bg-slate-700 text-slate-200 font-medium", children: "Copy Diagnostics" }), _jsx("button", { onClick: this.handleSafeMode, className: "w-full px-4 py-2 text-sm rounded bg-amber-700 hover:bg-amber-600 text-white font-medium", children: "Restart in Safe Mode" }), factoryResetBox] });

		            const footer = _jsx("p", { className: "text-xs text-slate-500 mt-4 text-center", children: "If this problem persists, please report it on GitHub." });

		            return (_jsx("div", { className: "min-h-screen bg-slate-950 flex items-center justify-center p-4", children: _jsxs("div", { className: "bg-slate-900 border border-red-700 rounded-lg shadow-xl max-w-md w-full p-6", children: [_jsx("h1", { className: "text-2xl font-semibold text-white mb-4", children: "Something went wrong" }), _jsx("p", { className: "text-slate-300 text-sm mb-4", children: "RedByte OS encountered an unexpected error. You can try reloading the page, or perform a factory reset to clear all data and start fresh." }), errorBox, actions, footer] }) }));
		        }
