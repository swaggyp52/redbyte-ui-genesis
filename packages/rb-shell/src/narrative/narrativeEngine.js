 ...
 */
export function onNarrativeChange(callback) {
 ...
 */
function checkPrerequisites(eventId) {
 ...
 */
export function trigger(eventId, metadata) {
    const store = useNarrativeStore.getState();
    const event = NARRATIVE_EVENTS[eventId];
    if (!event) {
 ...
 */
function displayNarrative(payload) {
