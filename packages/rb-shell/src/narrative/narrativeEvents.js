...
export const NARRATIVE_EVENTS = {
    'milestone.srLatchBuilt': {
        ...
        expandedMessage: 'The SR Latch you built is the foundation of all computer memory. ' +
    ...
    'milestone.dffUnderstood': {
        ...
        expandedMessage: 'D Flip-Flops capture data at precise clock edges, allowing billions of components ' +
    ...
    'milestone.counterRuns': {
        ...
        expandedMessage: 'Counters demonstrate how circuits can change over time. Each clock tick advances the state, ' +
    ...
    'milestone.fsmExplored': {
        ...
        expandedMessage: 'Finite State Machines bridge static logic and dynamic behavior. ' +
    ...
    'milestone.cpuExplored': {
        ...
        expandedMessage: 'A CPU is a state machine that fetches, decodes, and executes instructions. ' +
    ...
    'milestone.trackCComplete': {
        ...
        expandedMessage: 'From simple gates (Track A) through arithmetic (Track B) to sequential logic (Track C), ' +
