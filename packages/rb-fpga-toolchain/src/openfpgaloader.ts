 ...
 */
export async function programFpgaWithOpenFPGALoader(
  loaderPath: string,
 ...
 */
export async function detectBoardsWithOpenFPGALoader(
  loaderPath: string
): Promise<{
  success: boolean;
  boards: string[];
 ...
 */
export async function writeFpgaFlashWithOpenFPGALoader(
  loaderPath: string,
  bitstreamPath: string,
  board: string = 'basys3',
  onProgress?: (status: string, progress: number, log: string) => void
