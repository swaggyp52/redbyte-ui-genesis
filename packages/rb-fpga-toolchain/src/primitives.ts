 ...
 */
export function getPrimitive(nodeType: string): VerilogPrimitive | undefined {
 ...
 */
export function getPrimitivesLibrary(): string {
 ...
 */
export function getNodeTypeToModuleMap(): Map<string, string> {
 ...
 */
export function hasPrimitive(nodeType: string): boolean {
