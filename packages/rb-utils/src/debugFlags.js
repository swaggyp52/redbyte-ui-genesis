 ...
 * @param {string} key - localStorage key (e.g., 'rb:windowDebug')
 * @returns {boolean}
 */
export function isDebugFlagEnabled(key) {
 ...
 * @param {string} name - environment variable name (e.g., 'RB_BRIDGE_DRYRUN')
 * @param {string|boolean} [value] - expected value (optional; defaults to '1' or 'true')
 * @returns {boolean}
 */
export function isDevEnvSet(name, value) {
  try {
