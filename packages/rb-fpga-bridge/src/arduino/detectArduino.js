 ...
 */
export const KNOWN_ARDUINO_BOARDS = [
 ...
 */
export function detectArduinoModel(vid, pid) {
    ...
    return KNOWN_ARDUINO_BOARDS.find(board => board.vid.toLowerCase() === normalizedVid && board.pid.toLowerCase() === normalizedPid) || null;
}
/**
 ...
 */
export function isArduinoDevice(vid, pid) {
 ...
 */
export function identifyArduino(device) {
 ...
 */
export function getArduinoDisplayName(device) {
 ...
 */
export function getArduinoFQBN(model) {
