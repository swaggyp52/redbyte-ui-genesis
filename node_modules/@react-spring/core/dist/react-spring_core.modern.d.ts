 ...
 * ```
 *
 * @param refs â€“ An array of `SpringRef`s.
 * @param timeSteps â€“ Optional array of numbers that define the
 * delay between each animation from 0-1. The length should correlate
 * to the length of `refs`.
 * @param timeFrame â€“ Optional number that defines the total duration
 *
 * @public
 */
 ...
 * ```
 *
 * @param initial â€“ The initial value of the `SpringValue`.
 * @param props â€“ Typically the same props as `useSpring` e.g. `config`, `loop` etc.
 *
 * @public
 */
 ...
 * ```
 *
 * @param length â€“ The number of springs you want to create
 * @param propsArg â€“ The props to pass to the internal `useSprings` hook,
 ...
 * @param propsArg â€“ The props to pass to the internal `useSprings` hook,
 * therefore is the same as `useSprings`.
 * @param deps â€“ The optional array of dependencies to pass to the internal
