...
export interface GeneratorOptions {
    ...
    jsescOption?: {
         ...
         * environments is a concern, donâ€™t enable this setting. If the json setting is enabled, the value for the es6
         ...
         * enabled, all the symbols in the output are escaped â€” even printable ASCII symbols.
         */
         ...
         * is escaped as \x3C!-- (or \u003C!-- when the json option is enabled). This setting is useful when jsescâ€™s
         ...
         * the output for arrays and objects is as compact as possible; itâ€™s not formatted nicely.
         */
