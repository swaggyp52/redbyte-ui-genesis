...
export declare class DynamicRayCastVehicleController {
    ...
    free(): void;
    /**
     * Updates the vehicleâ€™s velocity based on its suspension, engine force, and brake.
     *
     * This directly updates the velocity of its chassis rigid-body.
     *
     * @param dt - Time increment used to integrate forces.
     * @param filterFlags - Flag to exclude categories of objects from the wheelsâ€™ ray-cast.
     * @param filterGroups - Only colliders compatible with these groups will be hit by the wheelsâ€™ ray-casts.
     * @param filterPredicate - Callback to filter out which collider will be hit by the wheelsâ€™ ray-casts.
     */
    ...
    chassis(): RigidBody;
    /**
     * The chassisâ€™ local _up_ direction (`0 = x, 1 = y, 2 = z`).
     */
    get indexUpAxis(): number;
    /**
     * Sets the chassisâ€™ local _up_ direction (`0 = x, 1 = y, 2 = z`).
     */
    set indexUpAxis(axis: number);
    /**
     * The chassisâ€™ local _forward_ direction (`0 = x, 1 = y, 2 = z`).
     */
    get indexForwardAxis(): number;
    /**
     * Sets the chassisâ€™ local _forward_ direction (`0 = x, 1 = y, 2 = z`).
     */
     ...
     * @param directionCs - The direction of the wheelâ€™s suspension, relative to the chassis. The ray-casting will
     *                      happen following this direction to detect the ground.
     * @param axleCs - The wheelâ€™s axle axis, relative to the chassis.
     * @param suspensionRestLength - The rest length of the wheelâ€™s suspension spring.
     * @param radius - The wheelâ€™s radius.
     */
    ...
    /**
     * The rest length of the i-th wheelâ€™s suspension spring.
     */
    wheelSuspensionRestLength(i: number): number | null;
    /**
     * Sets the rest length of the i-th wheelâ€™s suspension spring.
     */
    ...
    /**
     * The i-th wheelâ€™s radius.
     */
    wheelRadius(i: number): number | null;
    /**
     * Sets the i-th wheelâ€™s radius.
     */
    setWheelRadius(i: number, value: number): void;
    /**
     * The i-th wheelâ€™s suspension stiffness.
     *
     * Increase this value if the suspension appears to not push the vehicle strong enough.
     */
    wheelSuspensionStiffness(i: number): number | null;
    /**
     * Sets the i-th wheelâ€™s suspension stiffness.
     *
     * Increase this value if the suspension appears to not push the vehicle strong enough.
     */
    setWheelSuspensionStiffness(i: number, value: number): void;
    /**
     * The i-th wheelâ€™s suspensionâ€™s damping when it is being compressed.
     */
    ...
    /**
     * The i-th wheelâ€™s suspensionâ€™s damping when it is being released.
     *
     * Increase this value if the suspension appears to overshoot.
     */
    wheelSuspensionRelaxation(i: number): number | null;
    /**
     * Sets the i-th wheelâ€™s suspensionâ€™s damping when it is being released.
     *
     * Increase this value if the suspension appears to overshoot.
     */
    setWheelSuspensionRelaxation(i: number, value: number): void;
    /**
     * The maximum force applied by the i-th wheelâ€™s suspension.
     */
    wheelMaxSuspensionForce(i: number): number | null;
    /**
     * Sets the maximum force applied by the i-th wheelâ€™s suspension.
     */
    ...
    /**
     * The direction of the i-th wheelâ€™s suspension, relative to the chassis.
     *
     * The ray-casting will happen following this direction to detect the ground.
     */
    wheelDirectionCs(i: number): Vector | null;
    /**
     * Sets the direction of the i-th wheelâ€™s suspension, relative to the chassis.
     *
     * The ray-casting will happen following this direction to detect the ground.
     */
    setWheelDirectionCs(i: number, value: Vector): void;
    /**
     * The i-th wheelâ€™s axle axis, relative to the chassis.
     *
     * The axis index defined as 0 = X, 1 = Y, 2 = Z.
     */
    wheelAxleCs(i: number): Vector | null;
    /**
     * Sets the i-th wheelâ€™s axle axis, relative to the chassis.
     *
     * The axis index defined as 0 = X, 1 = Y, 2 = Z.
     */
     ...
     * causing the vehicle to flip if itâ€™s too strong).
     */
    ...
    /**
     * The multiplier of friction between a tire and the collider itâ€™s on top of.
     *
    ...
    /**
     *  The i-th wheelâ€™s current rotation angle (radians) on its axle.
     */
    ...
    /**
     *  The (world-space) point hit by the wheelâ€™s ray-cast for the i-th wheel.
     */
