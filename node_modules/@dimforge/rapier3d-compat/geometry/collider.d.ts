...
export declare class ColliderDesc {
     ...
     * @param principalAngularInertia âˆ’ The initial principal angular inertia of the collider to create.
     *                                  These are the eigenvalues of the angular inertia matrix.
     * @param angularInertiaLocalFrame âˆ’ The initial local angular inertia frame of the collider to create.
