...
export interface PhysicsHooks {
     ...
     *
     * @param collider1 âˆ’ Handle of the first collider involved in the potential contact.
     * @param collider2 âˆ’ Handle of the second collider involved in the potential contact.
     * @param body1 âˆ’ Handle of the first body involved in the potential contact.
     * @param body2 âˆ’ Handle of the second body involved in the potential contact.
     */
