...
- The next Project slice should reduce loaded-state detail sprawl further by clarifying how much of the lower mapping/details region needs to stay visible before the student scrolls.
