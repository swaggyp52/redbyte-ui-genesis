...
| Classroom durability target | `docs/architecture/RED_BYTE_PROJECT_DURABILITY_MODEL.md`, `docs/architecture/ADR_PROJECT_DURABILITY_STORAGE.md` | Current local persistence authority, Phase 3F browser rehearsal proof, and future storage-facade/journal/rolling-snapshot target. No storage migration is implied by the docs. |
