...
| Wrong-build diagnosis | `docs/product/WRONG_BUILD_DIAGNOSIS_AND_REPAIR_GAP_MAP.md` | Current Round 14B wrong-circuit repair map: failed Compare -> Inspect Design -> direct driver facts -> design repair -> rerun Compare -> Export E0 boundary. |
