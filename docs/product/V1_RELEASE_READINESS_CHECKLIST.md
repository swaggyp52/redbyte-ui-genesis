...
**Honest posture:** RC1 (frozen 2026-04-23). Core student workflow proven. Release engineering gates are green; course quick starts and Windows scripts are in place; fresh-clone course setup rehearsal is the next handoff risk.
...
- [x] Windows course scripts merged to `main` (`setup.ps1`, `launch.ps1`, `doctor.ps1`, `update.ps1`, `reset.ps1`) with course-script static gate
- [x] Student Quick Start and Professor Quick Start docs exist under `docs/course/`
- [x] Evidence-level and troubleshooting fast-path docs exist under `docs/course/`
...
| Fresh Windows course-script rehearsal | Scripts are merged, but not yet tested from a fresh clone / fresh Windows profile | Run setup/launch/doctor/update/reset rehearsal from a fresh clone or clean Windows profile |
