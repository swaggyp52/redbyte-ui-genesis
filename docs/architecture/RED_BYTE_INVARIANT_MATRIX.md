...
| Proposed gate | Why |
|---|---|
| Design canvas-first workbench gate or strengthened `ide:gate:design-workbench-integrity` | After the Design Workbench slice, prove meaningful loaded graph nodes/connections are first-viewport focal content at classroom and desktop viewports. |
