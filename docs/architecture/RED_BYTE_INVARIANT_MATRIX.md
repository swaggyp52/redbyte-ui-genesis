...
| Proposed gate | Why |
|---|---|
| `ide:gate:hardware-basys3-workbench` or strengthened Hardware credibility gate | After the Hardware / Basys3 Workbench slice, prove signal -> board resource -> package pin -> XDC hierarchy, E0-safe wording, and no E1/E2/E3 overclaim. |
