...
| Verify V2 rendered truth workbench | Feed `verifyTruthState.ts` from runtime and add focused browser gates for Course/My checks, locked expected values, stale design/testbench, selected failure repair, and sequential timing visibility. |
