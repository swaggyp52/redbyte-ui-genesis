...
| RB-INV-025 | `classroom:gate` must include trust-critical lightweight browser gates. | CI/Classroom | classroom gate script | includes design workbench, Design Workbench v1, Design no-bridge, shell layout, shell workbench hierarchy, Project command center, Export trust, Export handoff station, Hardware Basys3 workbench, Import recovery, and Verify evidence workbench integrity gates | runtime duration can grow; monitor CI time | P1 |
| RB-INV-026 | Broader classroom verifier must include the same invariant gates for local/nightly breadth. | CI/Classroom | `verify-gates-classroom.mjs` | includes design workbench, Design Workbench v1, Design no-bridge, shell layout, shell workbench hierarchy, Project command center, Export trust, Export handoff station, Hardware Basys3 workbench, Import recovery, and Verify evidence workbench integrity gates | broad suite can be slow | P2 |
