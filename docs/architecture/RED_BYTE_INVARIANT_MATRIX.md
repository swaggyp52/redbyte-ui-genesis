...
| RB-INV-025 | `classroom:gate` must include trust-critical lightweight browser gates. | CI/Classroom | classroom gate script | includes active mode reload recovery, Verify saved-checks default, design workbench, Design Workbench v1, Design no-bridge, workbench space utilization, workbench visual finish, shell layout, shell workbench hierarchy, Project command center, Export trust, Export handoff station, Hardware Basys3 workbench, Import recovery, and Verify evidence workbench integrity gates | runtime duration can grow; monitor CI time | P1 |
| RB-INV-026 | Broader classroom verifier must include the same invariant gates for local/nightly breadth. | CI/Classroom | `verify-gates-classroom.mjs` | includes active mode reload recovery, Verify saved-checks default, design workbench, Design Workbench v1, Design no-bridge, workbench space utilization, workbench visual finish, shell layout, shell workbench hierarchy, Project command center, Export trust, Export handoff station, Hardware Basys3 workbench, Import recovery, and Verify evidence workbench integrity gates | broad suite can be slow | P2 |
...
| Proposed gate | Why |
|---|---|
| Hardware Basys3 first-viewport hierarchy | Browser-first inspection found the board/table starts too low at `1366x768`; use focused visual proof without changing pin mapping or E1/E2/E3 claims. |
