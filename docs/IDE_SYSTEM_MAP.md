...
| `ide-verify-evidence-workbench-integrity.mjs` | Verify evidence gate proves visible first-run expected-output editing, Compare PASS, intentional FAIL, first mismatch expected/observed values, waveform evidence, repair PASS, and no evidence-region overlap |
