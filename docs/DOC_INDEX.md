...
| [product/RED_BYTE_OPERATING_LOOP.md](./product/RED_BYTE_OPERATING_LOOP.md) | Session closeout operating loop contract that links repo truth, Marcus sync, and next-agent handoff through `rb:session:status|close|test` |
