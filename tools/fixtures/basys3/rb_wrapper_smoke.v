// RedByte Basys 3 smoke fixture: IDENTIFY + STREAM_START/STOP + SAMPLE over UART.
// UART pins: RsRx (B18), RsTx (A18) per board-model pinmap.
...
module rb_wrapper_smoke_basys3 (
  input  wire clk,
  input  wire RsRx,
  output wire RsTx,
  output reg  [15:0] led
  ...
  always @(posedge clk) begin
    led <= streaming_enabled ? 16'h0001 : 16'h0000;
  end
