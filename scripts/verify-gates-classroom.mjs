...
function main() {
  ...
  const results = [
    ...
    runGate('ide:design-canvas-direct-workbench', 'pnpm -s ide:gate:design-canvas-direct-workbench', true),
    runGate('ide:design-workspace-crash-proof', 'pnpm -s ide:gate:design-workspace-crash-proof', true),
    runGate('ide:workbench-stability-overhaul', 'pnpm -s ide:gate:workbench-stability-overhaul', true),
    ...
    runGate('ide:project-loaded-paths-first-viewport', 'pnpm -s ide:gate:project-loaded-paths-first-viewport', true),
    runGate('ide:project-loaded-command-surface', 'pnpm -s ide:gate:project-loaded-command-surface', true),
    ...
    runGate('ide:v2-student-chrome', 'pnpm -s ide:gate:v2-student-chrome', true),
    ...
    runGate('ide:verify-accessibility-v2', 'pnpm -s ide:gate:verify-accessibility-v2', true),
    runGate('ide:verify-keyboard-grid-v2', 'pnpm -s ide:gate:verify-keyboard-grid-v2', true),
    runGate('ide:verify-zoom-contrast-v2', 'pnpm -s ide:gate:verify-zoom-contrast-v2', true),
    runGate('ide:project-durability-v2', 'pnpm -s ide:gate:project-durability-v2', true),
    runGate('ide:verify-corrupt-state-recovery-v2', 'pnpm -s ide:gate:verify-corrupt-state-recovery-v2', true),
    runGate('ide:verify-multitab-conflict-v2', 'pnpm -s ide:gate:verify-multitab-conflict-v2', true),
    runGate('ide:diagnostics-bundle-v2', 'pnpm -s ide:gate:diagnostics-bundle-v2', true),
    ...
    runGate('ide:export-package-inspector', 'pnpm -s ide:gate:export-package-inspector', true),
    runGate(
    ...
    runGate('ide:authoring-depth-release-safety', 'pnpm -s ide:gate:authoring-depth-release-safety', true),
    ...
    runGate('ide:shell-navigation-overhaul', 'pnpm -s ide:gate:shell-navigation-overhaul', true),
    runGate('ide:primary-work-object-dominance', 'pnpm -s ide:gate:primary-work-object-dominance', true),
    runGate('ide:nested-scroll-regression', 'pnpm -s ide:gate:nested-scroll-regression', true),
    runGate('ide:root-overflow-regression', 'pnpm -s ide:gate:root-overflow-regression', true),
    runGate('ide:workbench-reconstruction-v1', 'pnpm -s ide:gate:workbench-reconstruction-v1', true),
    runGate('ide:design-dual-tool-windows', 'pnpm -s ide:gate:design-dual-tool-windows', true),
    runGate('ide:design-library-not-cropped', 'pnpm -s ide:gate:design-library-not-cropped', true),
    runGate('ide:design-tool-window-coexistence', 'pnpm -s ide:gate:design-tool-window-coexistence', true),
    runGate('ide:verify-task-plane-usability', 'pnpm -s ide:gate:verify-task-plane-usability', true),
    runGate('ide:hardware-board-dominance', 'pnpm -s ide:gate:hardware-board-dominance', true),
    runGate('ide:hardware-board-unblocked', 'pnpm -s ide:gate:hardware-board-unblocked', true),
    runGate('ide:hardware-resource-catalog-not-obstructing', 'pnpm -s ide:gate:hardware-resource-catalog-not-obstructing', true),
    runGate('ide:release-readiness-visual-contract', 'pnpm -s ide:gate:release-readiness-visual-contract', true),
    runGate('ide:no-cropped-controls-regression', 'pnpm -s ide:gate:no-cropped-controls-regression', true),
    runGate('ide:action-first-entry-surfaces', 'pnpm -s ide:gate:action-first-entry-surfaces', true),
    ...
    runGate('ide:browser-e0-packaging-readiness', 'pnpm -s ide:gate:browser-e0-packaging-readiness', true),
