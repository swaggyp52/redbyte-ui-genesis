const VERIFY_RESULT_TERMINAL_PATTERN =
  /(ASSERTIONS MATCH|ASSERTIONS DIFFER|ASSERTIONS INCOMPLETE|CHECKS ALIGNED|CHECKS FAILED|CHECKS NEED REVIEW|STIMULUS ONLY|OBSERVATION ONLY|OBSERVATION ONLY|OBSERVATION|PASS|FAIL|TRACE)/i;
