const VERIFY_RESULT_TERMINAL_PATTERN =
  /(ASSERTIONS MATCH|ASSERTIONS DIFFER|ASSERTIONS INCOMPLETE|CHECKS ALIGNED|CHECKS FAILED|CHECKS NEED REVIEW|DESIGN BLOCKED|CANNOT VERIFY|INCONCLUSIVE|SIMULATION COMPLETE|SIMULATION BLOCKED|STIMULUS ONLY|OBSERVATION ONLY|OBSERVATION|PASS|FAIL|TRACE)/i;
...
const VERIFY_TRACE_PATTERN = /(NO CHECKS CONFIGURED|STIMULUS ONLY|OBSERVATION ONLY|OBSERVATION|TRACE)/i;
